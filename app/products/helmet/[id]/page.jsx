                                ...
                                <div className="product-main-content">
                                    <div className="row mb-60" style={{ alignItems: "flex-start" }}>
                                        ...
                                        <div className="col-lg-6 mb-4 mb-lg-0">
                                            <div className="product-image-wrapper p-relative tp-round-10 p-4 mb-4" style={{ backgroundColor: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.05)", display: "flex", justifyContent: "center", alignItems: "center", minHeight: "550px", transition: "all 0.3s ease" }}>
                                        ...
                                        <div className="col-lg-6">
                                            <div className="product-info pl-lg-30">
                                                ...
                                                <div className="d-flex flex-wrap gap-4 mb-40">
                                                    <div>
                                                        ...
                                                        <div className="d-flex gap-3">
                                                            {[
                                                                ...
                                                                <div key={c.name} className="color-circle" title={c.name} style={{ width: "36px", height: "36px", borderRadius: "50%", backgroundColor: c.color, border: "2px solid rgba(255,255,255,0.2)", cursor: "pointer", transition: "all 0.2s" }} onMouseEnter={(e) => { e.currentTarget.style.borderColor = "#c8ff00"; e.currentTarget.style.transform = "scale(1.1)"; }} onMouseLeave={(e) => { e.currentTarget.style.borderColor = "rgba(255,255,255,0.2)"; e.currentTarget.style.transform = "scale(1)"; }}></div>
                                                            ))}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="ms-lg-4">
                                                        ...
                                                        <div className="d-flex gap-2">
                                                            {["S", "M", "L", "XL"].map((s) => (
                                                                <button key={s} className="size-btn tp-ff-inter fw-600" style={{ width: "40px", height: "40px", borderRadius: "8px", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", transition: "all 0.2s" }} onMouseEnter={(e) => { e.currentTarget.style.borderColor = "#c8ff00"; e.currentTarget.style.color = "#c8ff00"; }} onMouseLeave={(e) => { e.currentTarget.style.borderColor = "rgba(255,255,255,0.1)"; e.currentTarget.style.color = "#fff"; }}>
                                                                    {s}
                                                                </button>
                                                            ))}
                                                        </div>
                                                ...
                                                {/* Section 4: Compatible Accessories */}
                                                ...
                                                {/* Section 5: Certificate Button - Bottom of Content */}
