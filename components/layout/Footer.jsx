              ...
              <div className="col-12">
                <div className="tp-footer-ai-copyright text-center">
                    <p className="tp-ff-dm fw-500 tp-text-common-white">
                      ...
                      Copyright {new Date().getFullYear()} <a href={withBasePath("/")} className="hover-text-white" style={{ color: "inherit", textDecoration: "none", fontWeight: "600" }}>KNYX</a>. All Rights Reserved.
                    </p>
                </div>
              </div>
            </div>
