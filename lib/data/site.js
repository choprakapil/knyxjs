...
export const siteData = {
  ...
  socials: [
    ...
    { network: "twitter", url: "https://x.com/KnyxSports" },
    { network: "youtube", url: "https://youtube.com/@knyxsports?si=-5LPpbA3wbrCeOAj" }
  ],
  ui: {
  ...
  seo: {
    title: "KNYX | Elite Sports Protection",
