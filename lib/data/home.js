export const homeData = {
  ...
  //       ],
  //       footer: "Because true confidence begins with trust in your gear."
  //     },
  //     {
  ...
  //       ],
  //       footer: "These principles guide every product we create."
  //     },
  //     {
  //       title: "For the New Age Knight",
  //       content: [
  ...
  brandStory: {
    title: "Brand Story",
    brandName: "KNYX",
    intro: "Inspired by the word NYX, meaning night, and transformed into KNYX, meaning knight, our brand represents the new age athlete — focused, fearless, and equipped. We exist to protect the moments that matter in sport.",
    sections: [
      {
        title: "The Origin",
        content: [
